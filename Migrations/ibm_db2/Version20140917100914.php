...
class Version20140917100914 extends AbstractMigration
{
    ...
    {
        $this->addSql("
            ALTER TABLE laurent_school_plan_matiere ALTER refProgramme refProgramme VARCHAR(255) DEFAULT NULL
        ");
        $this->addSql("
    ...
    public function down(Schema $schema)
    {
        ...
        ");
        $this->addSql("
            ALTER TABLE laurent_school_plan_matiere ALTER refProgramme refProgramme VARCHAR(255) NOT NULL
        ");
    }
}